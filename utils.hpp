 ...
 * the obtained progress code from code update.
 *
 * @param[in] prgCode - the tuple containing primary and
 * secondary progress code
 **/
...
/**
 * @brief method to create tuple for dbus method that displays information to
 * the op panel and adds an entry to the progress log
 *
...
/**
 * @brief method to display success message on op panel during usb code update
...
/**
 * @brief method to display same side installation message on op panel during
 * usb code update C100B101: The firmware image is being installed on a side of
 * the flash.
 *
 * @param[in] bus
 **/
 ...
 * during usb code update C100B102: The firmware image is being installed on
